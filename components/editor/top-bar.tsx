...
import { GitHubButton } from "@/components/editor/github-star-button";
import {
    AppWindow,
    ChevronDown,
    Plus,
...
export function TopBar() {
    const { code, setCode, getCleanCode, isLeftPanelOpen, toggleLeftPanel, isPropertiesPanelOpen, togglePropertiesPanel, isCodePanelOpen, toggleCodePanel, activeBreakpoint, setActiveBreakpoint } =
        useEditorStore();
                ...
                <div className="h-14 bg-background border-b border-border flex items-center justify-between px-3 shrink-0 gap-2">
                    ...
                    <div className="flex items-center gap-3">
                        <div className="flex items-center gap-2">
                            <Tooltip disableHoverableContent>
                                <TooltipTrigger asChild>
                                    <Button variant="outline" size="icon" className="h-8 w-8 px-0 border" onClick={() => setTheme(resolvedTheme === "dark" ? "light" : "dark")}>
                        ...
                        <ButtonGroup>
                            ...
                            <TopBarButton icon={Play} tooltip="Preview" variant="outline" iconClassName="fill-current text-primary" onClick={() => openInNewTab(getCleanCode())} />
